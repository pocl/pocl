...
<h1>March, 2016: pocl v0.13 released</h2>

<p>This release adds:
<ul>
<li> kernel compiler support for LLVM/Clang 3.8
<li> initial (partial) OpenCL 2.0 support
<li> CMake build system almost on parity with autotools
</ul>
</p>
