...
define zeroext i1 @_Z36pocl_atomic_flag_test_and_set__localPVU3AS2U7_Atomici12memory_order12memory_scope(i32 addrspace(3)* %object, i32 %order, i32 %scope) #0 {
  %1 = bitcast i32 addrspace(3)* %object to i8 addrspace(3)*
  switch i32 %order, label %10 [
    i32 0, label %.thread
    i32 1, label %.thread1
    i32 2, label %.thread2
...
.thread:                                          ; preds = %0
  %5 = atomicrmw volatile xchg i8 addrspace(3)* %1, i8 1 monotonic
  br label %2

.thread1:                                         ; preds = %0
  %6 = atomicrmw volatile xchg i8 addrspace(3)* %1, i8 1 acquire
  br label %2

.thread2:                                         ; preds = %0
  %7 = atomicrmw volatile xchg i8 addrspace(3)* %1, i8 1 release
  br label %2

; <label>:8                                       ; preds = %0
  %9 = atomicrmw volatile xchg i8 addrspace(3)* %1, i8 1 acq_rel
  br label %2

; <label>:10                                      ; preds = %0
  %11 = atomicrmw volatile xchg i8 addrspace(3)* %1, i8 1 seq_cst
  br label %2
}
...
.thread:                                          ; preds = %0, %0, %0
  store atomic volatile i8 0, i8 addrspace(3)* %1 monotonic, align 1
  br label %2

.thread1:                                         ; preds = %0
  store atomic volatile i8 0, i8 addrspace(3)* %1 release, align 1
  br label %2

; <label>:3                                       ; preds = %0
  store atomic volatile i8 0, i8 addrspace(3)* %1 seq_cst, align 1
  br label %2
}
