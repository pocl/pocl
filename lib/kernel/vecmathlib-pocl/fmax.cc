...
half _cl_fmax(half x0, half x1)
{
  ...
  vecmathlib::realvec<half,1> r = vecmathlib::fmax(y0, y1);
...
half _cl_fmax(half x0, half x1)
{
  ...
  vecmathlib::realpseudovec<half,1> r = fmax(y0, y1);
  return (r)[0];
}
#else
// Implement fmax by calling builtin
half _cl_fmax(half x0, half x1)
{
  vecmathlib::realbuiltinvec<half,1> y0 = x0;
  vecmathlib::realbuiltinvec<half,1> y1 = x1;
  vecmathlib::realbuiltinvec<half,1> r = fmax(y0, y1);
  return (r)[0];
}
#endif
...
// Implement fmax by calling vecmathlib
half2 _cl_fmax(half2 x0, half2 x1)
{
  ...
  vecmathlib::realvec<half,2> r = vecmathlib::fmax(y0, y1);
...
// Implement fmax by calling vecmathlib
half3 _cl_fmax(half3 x0, half3 x1)
{
  ...
  vecmathlib::realvec<half,3> r = vecmathlib::fmax(y0, y1);
...
// Implement fmax by calling vecmathlib
half4 _cl_fmax(half4 x0, half4 x1)
{
  ...
  vecmathlib::realvec<half,4> r = vecmathlib::fmax(y0, y1);
...
// Implement fmax by calling vecmathlib
half8 _cl_fmax(half8 x0, half8 x1)
{
...
// Implement fmax by calling vecmathlib
half16 _cl_fmax(half16 x0, half16 x1)
{
  ...
  vecmathlib::realvec<half,16> r = vecmathlib::fmax(y0, y1);
...
float _cl_fmax(float x0, float x1)
{
  ...
  vecmathlib::realbuiltinvec<float,1> r = fmax(y0, y1);
  return (r)[0];
}
#endif
...
double _cl_fmax(double x0, double x1)
{
  ...
  vecmathlib::realbuiltinvec<double,1> r = fmax(y0, y1);
  return (r)[0];
}
#endif
