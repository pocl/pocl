...
// Implement pow by calling vecmathlib
half _cl_pow(half x0, half x1)
{
...
// Implement pow by calling vecmathlib
half2 _cl_pow(half2 x0, half2 x1)
{
  ...
  vecmathlib::realvec<half,2> r = vecmathlib::pow(y0, y1);
...
// Implement pow by using a larger vector size
half4 _cl_pow(half4, half4);
half2 _cl_pow(half2 x0, half2 x1)
{
  half4 y0 = bitcast<half2,half4>(x0);
  half4 y1 = bitcast<half2,half4>(x1);
  half4 r = _cl_pow(y0, y1);
  return bitcast<half4,half2>(r);
}
#else
// Implement pow by splitting into a smaller vector size
half _cl_pow(half, half);
half2 _cl_pow(half2 x0, half2 x1)
{
  pair_half y0 = bitcast<half2,pair_half>(x0);
  pair_half y1 = bitcast<half2,pair_half>(x1);
  pair_half r;
  r.lo = _cl_pow(y0.lo, y1.lo);
  r.hi = _cl_pow(y0.hi, y1.hi);
...
// Implement pow by calling vecmathlib
half3 _cl_pow(half3 x0, half3 x1)
{
  ...
  vecmathlib::realvec<half,3> r = vecmathlib::pow(y0, y1);
...
// Implement pow by calling vecmathlib
half4 _cl_pow(half4 x0, half4 x1)
{
  ...
  vecmathlib::realvec<half,4> r = vecmathlib::pow(y0, y1);
...
// Implement pow by calling vecmathlib
half8 _cl_pow(half8 x0, half8 x1)
{
...
// Implement pow by calling vecmathlib
half16 _cl_pow(half16 x0, half16 x1)
{
  ...
  vecmathlib::realvec<half,16> r = vecmathlib::pow(y0, y1);
...
// Implement pow by calling vecmathlib
float _cl_pow(float x0, float x1)
{
  ...
  vecmathlib::realvec<float,1> r = vecmathlib::pow(y0, y1);
...
float _cl_pow(float x0, float x1)
{
  ...
  vecmathlib::realpseudovec<float,1> r = pow(y0, y1);
  return (r)[0];
}
#else
// Implement pow by calling builtin
float _cl_pow(float x0, float x1)
{
  ...
  vecmathlib::realbuiltinvec<float,1> r = pow(y0, y1);
  return (r)[0];
}
#endif
...
// Implement pow by calling vecmathlib
float2 _cl_pow(float2 x0, float2 x1)
{
  ...
  vecmathlib::realvec<float,2> r = vecmathlib::pow(y0, y1);
...
float2 _cl_pow(float2 x0, float2 x1)
{
  ...
  float4 r = _cl_pow(y0, y1);
  return bitcast<float4,float2>(r);
}
#else
// Implement pow by splitting into a smaller vector size
float _cl_pow(float, float);
float2 _cl_pow(float2 x0, float2 x1)
{
...
// Implement pow by calling vecmathlib
float3 _cl_pow(float3 x0, float3 x1)
{
  ...
  vecmathlib::realvec<float,3> r = vecmathlib::pow(y0, y1);
...
// Implement pow by calling vecmathlib
float4 _cl_pow(float4 x0, float4 x1)
{
  ...
  vecmathlib::realvec<float,4> r = vecmathlib::pow(y0, y1);
...
// Implement pow by calling vecmathlib
float8 _cl_pow(float8 x0, float8 x1)
{
  ...
  vecmathlib::realvec<float,8> r = vecmathlib::pow(y0, y1);
...
// Implement pow by calling vecmathlib
float16 _cl_pow(float16 x0, float16 x1)
{
  ...
  vecmathlib::realvec<float,16> r = vecmathlib::pow(y0, y1);
...
// Implement pow by calling vecmathlib
double _cl_pow(double x0, double x1)
{
  ...
  vecmathlib::realvec<double,1> r = vecmathlib::pow(y0, y1);
...
double _cl_pow(double x0, double x1)
{
  ...
  vecmathlib::realpseudovec<double,1> r = pow(y0, y1);
  return (r)[0];
}
#else
// Implement pow by calling builtin
double _cl_pow(double x0, double x1)
{
  ...
  vecmathlib::realbuiltinvec<double,1> r = pow(y0, y1);
  return (r)[0];
}
#endif
...
// Implement pow by calling vecmathlib
double2 _cl_pow(double2 x0, double2 x1)
{
  ...
  vecmathlib::realvec<double,2> r = vecmathlib::pow(y0, y1);
...
double2 _cl_pow(double2 x0, double2 x1)
{
  ...
  double4 r = _cl_pow(y0, y1);
  return bitcast<double4,double2>(r);
}
#else
// Implement pow by splitting into a smaller vector size
double _cl_pow(double, double);
double2 _cl_pow(double2 x0, double2 x1)
{
...
// Implement pow by calling vecmathlib
double3 _cl_pow(double3 x0, double3 x1)
{
  ...
  vecmathlib::realvec<double,3> r = vecmathlib::pow(y0, y1);
...
#else
// Implement pow by splitting into a smaller vector size
double2 _cl_pow(double2, double2);
double3 _cl_pow(double3 x0, double3 x1)
{
...
// Implement pow by calling vecmathlib
double4 _cl_pow(double4 x0, double4 x1)
{
  ...
  vecmathlib::realvec<double,4> r = vecmathlib::pow(y0, y1);
...
// Implement pow by calling vecmathlib
double8 _cl_pow(double8 x0, double8 x1)
{
  ...
  vecmathlib::realvec<double,8> r = vecmathlib::pow(y0, y1);
...
// Implement pow by calling vecmathlib
double16 _cl_pow(double16 x0, double16 x1)
{
  ...
  vecmathlib::realvec<double,16> r = vecmathlib::pow(y0, y1);
