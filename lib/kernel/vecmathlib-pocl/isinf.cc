...
// Implement isinf by calling vecmathlib
short2 _cl_isinf(half2 x0)
{
  vecmathlib::realvec<half,2> y0 = bitcast<half2,vecmathlib::realvec<half,2> >(x0);
  vecmathlib::realvec<half,2>::boolvec_t r = vecmathlib::isinf(y0);
...
// Implement isinf by using a larger vector size
short4 _cl_isinf(half4);
short2 _cl_isinf(half2 x0)
{
  half4 y0 = bitcast<half2,half4>(x0);
  short4 r = _cl_isinf(y0);
  return bitcast<short4,short2>(r);
}
#else
// Implement isinf by splitting into a smaller vector size
int _cl_isinf(half);
short2 _cl_isinf(half2 x0)
{
  pair_half y0 = bitcast<half2,pair_half>(x0);
  pair_short r;
  r.lo = -_cl_isinf(y0.lo);
  r.hi = -_cl_isinf(y0.hi);
...
// Implement isinf by calling vecmathlib
short3 _cl_isinf(half3 x0)
{
  vecmathlib::realvec<half,3> y0 = bitcast<half3,vecmathlib::realvec<half,3> >(x0);
  vecmathlib::realvec<half,3>::boolvec_t r = vecmathlib::isinf(y0);
...
// Implement isinf by calling vecmathlib
short4 _cl_isinf(half4 x0)
{
  vecmathlib::realvec<half,4> y0 = bitcast<half4,vecmathlib::realvec<half,4> >(x0);
  vecmathlib::realvec<half,4>::boolvec_t r = vecmathlib::isinf(y0);
...
// Implement isinf by using a larger vector size
short8 _cl_isinf(half8);
short4 _cl_isinf(half4 x0)
{
  half8 y0 = bitcast<half4,half8>(x0);
  short8 r = _cl_isinf(y0);
...
// Implement isinf by calling vecmathlib
short8 _cl_isinf(half8 x0)
{
  vecmathlib::realvec<half,8> y0 = bitcast<half8,vecmathlib::realvec<half,8> >(x0);
  vecmathlib::realvec<half,8>::boolvec_t r = vecmathlib::isinf(y0);
...
// Implement isinf by using a larger vector size
short16 _cl_isinf(half16);
short8 _cl_isinf(half8 x0)
{
  half16 y0 = bitcast<half8,half16>(x0);
  short16 r = _cl_isinf(y0);
...
// Implement isinf by calling vecmathlib
short16 _cl_isinf(half16 x0)
{
  vecmathlib::realvec<half,16> y0 = bitcast<half16,vecmathlib::realvec<half,16> >(x0);
  vecmathlib::realvec<half,16>::boolvec_t r = vecmathlib::isinf(y0);
...
// Implement isinf by calling vecmathlib
int _cl_isinf(float x0)
{
  vecmathlib::realvec<float,1> y0 = bitcast<float,vecmathlib::realvec<float,1> >(x0);
  vecmathlib::realvec<float,1>::boolvec_t r = vecmathlib::isinf(y0);
...
int _cl_isinf(float x0)
{
  ...
  vecmathlib::realpseudovec<float,1>::boolvec_t r = isinf(y0);
  return vecmathlib::convert_int(r)[0];
}
#else
// Implement isinf by calling builtin
int _cl_isinf(float x0)
{
  ...
  vecmathlib::realbuiltinvec<float,1>::boolvec_t r = isinf(y0);
  return vecmathlib::convert_int(r)[0];
}
#endif
...
// Implement isinf by calling vecmathlib
int2 _cl_isinf(float2 x0)
{
  vecmathlib::realvec<float,2> y0 = bitcast<float2,vecmathlib::realvec<float,2> >(x0);
  vecmathlib::realvec<float,2>::boolvec_t r = vecmathlib::isinf(y0);
...
// Implement isinf by calling vecmathlib
int3 _cl_isinf(float3 x0)
{
  vecmathlib::realvec<float,3> y0 = bitcast<float3,vecmathlib::realvec<float,3> >(x0);
  vecmathlib::realvec<float,3>::boolvec_t r = vecmathlib::isinf(y0);
...
// Implement isinf by calling vecmathlib
int4 _cl_isinf(float4 x0)
{
  vecmathlib::realvec<float,4> y0 = bitcast<float4,vecmathlib::realvec<float,4> >(x0);
  vecmathlib::realvec<float,4>::boolvec_t r = vecmathlib::isinf(y0);
...
// Implement isinf by calling vecmathlib
int8 _cl_isinf(float8 x0)
{
  vecmathlib::realvec<float,8> y0 = bitcast<float8,vecmathlib::realvec<float,8> >(x0);
  vecmathlib::realvec<float,8>::boolvec_t r = vecmathlib::isinf(y0);
...
// Implement isinf by using a larger vector size
int16 _cl_isinf(float16);
int8 _cl_isinf(float8 x0)
{
  float16 y0 = bitcast<float8,float16>(x0);
  int16 r = _cl_isinf(y0);
...
// Implement isinf by calling vecmathlib
int16 _cl_isinf(float16 x0)
{
  vecmathlib::realvec<float,16> y0 = bitcast<float16,vecmathlib::realvec<float,16> >(x0);
  vecmathlib::realvec<float,16>::boolvec_t r = vecmathlib::isinf(y0);
...
// Implement isinf by calling vecmathlib
int _cl_isinf(double x0)
{
  vecmathlib::realvec<double,1> y0 = bitcast<double,vecmathlib::realvec<double,1> >(x0);
  vecmathlib::realvec<double,1>::boolvec_t r = vecmathlib::isinf(y0);
...
int _cl_isinf(double x0)
{
  ...
  vecmathlib::realpseudovec<double,1>::boolvec_t r = isinf(y0);
  return vecmathlib::convert_int(r)[0];
}
#else
// Implement isinf by calling builtin
int _cl_isinf(double x0)
{
  ...
  vecmathlib::realbuiltinvec<double,1>::boolvec_t r = isinf(y0);
  return vecmathlib::convert_int(r)[0];
}
#endif
...
// Implement isinf by calling vecmathlib
long2 _cl_isinf(double2 x0)
{
  vecmathlib::realvec<double,2> y0 = bitcast<double2,vecmathlib::realvec<double,2> >(x0);
  vecmathlib::realvec<double,2>::boolvec_t r = vecmathlib::isinf(y0);
...
// Implement isinf by calling vecmathlib
long3 _cl_isinf(double3 x0)
{
  vecmathlib::realvec<double,3> y0 = bitcast<double3,vecmathlib::realvec<double,3> >(x0);
  vecmathlib::realvec<double,3>::boolvec_t r = vecmathlib::isinf(y0);
...
// Implement isinf by calling vecmathlib
long4 _cl_isinf(double4 x0)
{
  vecmathlib::realvec<double,4> y0 = bitcast<double4,vecmathlib::realvec<double,4> >(x0);
  vecmathlib::realvec<double,4>::boolvec_t r = vecmathlib::isinf(y0);
...
// Implement isinf by using a larger vector size
long8 _cl_isinf(double8);
long4 _cl_isinf(double4 x0)
{
  double8 y0 = bitcast<double4,double8>(x0);
  long8 r = _cl_isinf(y0);
...
// Implement isinf by calling vecmathlib
long8 _cl_isinf(double8 x0)
{
  vecmathlib::realvec<double,8> y0 = bitcast<double8,vecmathlib::realvec<double,8> >(x0);
  vecmathlib::realvec<double,8>::boolvec_t r = vecmathlib::isinf(y0);
...
// Implement isinf by using a larger vector size
long16 _cl_isinf(double16);
long8 _cl_isinf(double8 x0)
{
  double16 y0 = bitcast<double8,double16>(x0);
  long16 r = _cl_isinf(y0);
...
// Implement isinf by calling vecmathlib
long16 _cl_isinf(double16 x0)
{
  vecmathlib::realvec<double,16> y0 = bitcast<double16,vecmathlib::realvec<double,16> >(x0);
  vecmathlib::realvec<double,16>::boolvec_t r = vecmathlib::isinf(y0);
