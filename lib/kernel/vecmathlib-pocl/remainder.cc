...
half _cl_remainder(half x0, half x1)
{
  ...
  vecmathlib::realvec<half,1> r = vecmathlib::remainder(y0, y1);
...
half _cl_remainder(half x0, half x1)
{
  ...
  vecmathlib::realpseudovec<half,1> r = remainder(y0, y1);
  return (r)[0];
}
#else
// Implement remainder by calling builtin
half _cl_remainder(half x0, half x1)
{
  vecmathlib::realbuiltinvec<half,1> y0 = x0;
  vecmathlib::realbuiltinvec<half,1> y1 = x1;
  vecmathlib::realbuiltinvec<half,1> r = remainder(y0, y1);
  return (r)[0];
}
#endif
...
// Implement remainder by calling vecmathlib
half2 _cl_remainder(half2 x0, half2 x1)
{
  ...
  vecmathlib::realvec<half,2> r = vecmathlib::remainder(y0, y1);
...
// Implement remainder by calling vecmathlib
half3 _cl_remainder(half3 x0, half3 x1)
{
  ...
  vecmathlib::realvec<half,3> r = vecmathlib::remainder(y0, y1);
...
#else
// Implement remainder by splitting into a smaller vector size
half2 _cl_remainder(half2, half2);
half3 _cl_remainder(half3 x0, half3 x1)
{
...
// Implement remainder by calling vecmathlib
half4 _cl_remainder(half4 x0, half4 x1)
{
  ...
  vecmathlib::realvec<half,4> r = vecmathlib::remainder(y0, y1);
...
// Implement remainder by calling vecmathlib
half8 _cl_remainder(half8 x0, half8 x1)
{
...
// Implement remainder by calling vecmathlib
half16 _cl_remainder(half16 x0, half16 x1)
{
  ...
  vecmathlib::realvec<half,16> r = vecmathlib::remainder(y0, y1);
...
float _cl_remainder(float x0, float x1)
{
  ...
  vecmathlib::realbuiltinvec<float,1> r = remainder(y0, y1);
  return (r)[0];
}
#endif
...
double _cl_remainder(double x0, double x1)
{
  ...
  vecmathlib::realbuiltinvec<double,1> r = remainder(y0, y1);
  return (r)[0];
}
#endif
