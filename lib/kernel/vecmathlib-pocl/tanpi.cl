...
// tanpi: VF=half
// Implement tanpi directly
__attribute__((__overloadable__))
half _cl_tanpi(half x0)
{
...
#define ldexp_vector_ _cl_ldexp_half_short
  return tan(TYPED_CONST(scalar_t, M_PI_H, M_PI_F, M_PI)*x0);
...
// Implement tanpi directly
__attribute__((__overloadable__))
double16 _cl_tanpi(double16 x0)
{
  typedef long iscalar_t;
  typedef long jscalar_t;
  typedef int kscalar_t;
