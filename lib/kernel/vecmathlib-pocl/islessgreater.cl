...
// islessgreater: VF=half
// Implement islessgreater directly
__attribute__((__overloadable__))
int _cl_islessgreater(half x0, half x1)
{
...
// islessgreater: VF=half2
// Implement islessgreater directly
__attribute__((__overloadable__))
short2 _cl_islessgreater(half2 x0, half2 x1)
{
  typedef short iscalar_t;
...
// islessgreater: VF=half3
// Implement islessgreater directly
__attribute__((__overloadable__))
short3 _cl_islessgreater(half3 x0, half3 x1)
{
  typedef short iscalar_t;
  typedef short jscalar_t;
  typedef int kscalar_t;
...
// islessgreater: VF=half4
// Implement islessgreater directly
__attribute__((__overloadable__))
short4 _cl_islessgreater(half4 x0, half4 x1)
{
  typedef short iscalar_t;
  typedef short jscalar_t;
  typedef int kscalar_t;
...
// islessgreater: VF=half8
// Implement islessgreater directly
__attribute__((__overloadable__))
short8 _cl_islessgreater(half8 x0, half8 x1)
{
  typedef short iscalar_t;
  typedef short jscalar_t;
  typedef int kscalar_t;
...
// islessgreater: VF=half16
// Implement islessgreater directly
__attribute__((__overloadable__))
short16 _cl_islessgreater(half16 x0, half16 x1)
{
  typedef short iscalar_t;
  typedef short jscalar_t;
  typedef int kscalar_t;
...
// islessgreater: VF=float
// Implement islessgreater directly
__attribute__((__overloadable__))
int _cl_islessgreater(float x0, float x1)
{
...
// islessgreater: VF=float2
// Implement islessgreater directly
__attribute__((__overloadable__))
int2 _cl_islessgreater(float2 x0, float2 x1)
{
  typedef int iscalar_t;
  typedef int jscalar_t;
  typedef int kscalar_t;
...
// islessgreater: VF=float3
// Implement islessgreater directly
__attribute__((__overloadable__))
int3 _cl_islessgreater(float3 x0, float3 x1)
{
  typedef int iscalar_t;
  typedef int jscalar_t;
  typedef int kscalar_t;
...
// islessgreater: VF=float4
// Implement islessgreater directly
__attribute__((__overloadable__))
int4 _cl_islessgreater(float4 x0, float4 x1)
{
  typedef int iscalar_t;
  typedef int jscalar_t;
  typedef int kscalar_t;
...
// islessgreater: VF=float8
// Implement islessgreater directly
__attribute__((__overloadable__))
int8 _cl_islessgreater(float8 x0, float8 x1)
{
  typedef int iscalar_t;
  typedef int jscalar_t;
  typedef int kscalar_t;
...
// islessgreater: VF=float16
// Implement islessgreater directly
__attribute__((__overloadable__))
int16 _cl_islessgreater(float16 x0, float16 x1)
{
  typedef int iscalar_t;
  typedef int jscalar_t;
  typedef int kscalar_t;
...
// islessgreater: VF=double
// Implement islessgreater directly
__attribute__((__overloadable__))
int _cl_islessgreater(double x0, double x1)
{
...
// islessgreater: VF=double2
// Implement islessgreater directly
__attribute__((__overloadable__))
long2 _cl_islessgreater(double2 x0, double2 x1)
{
  typedef long iscalar_t;
...
// islessgreater: VF=double3
// Implement islessgreater directly
__attribute__((__overloadable__))
long3 _cl_islessgreater(double3 x0, double3 x1)
{
  typedef long iscalar_t;
  typedef long jscalar_t;
  typedef int kscalar_t;
...
// islessgreater: VF=double4
// Implement islessgreater directly
__attribute__((__overloadable__))
long4 _cl_islessgreater(double4 x0, double4 x1)
{
  typedef long iscalar_t;
  typedef long jscalar_t;
  typedef int kscalar_t;
...
// islessgreater: VF=double8
// Implement islessgreater directly
__attribute__((__overloadable__))
long8 _cl_islessgreater(double8 x0, double8 x1)
{
  typedef long iscalar_t;
  typedef long jscalar_t;
  typedef int kscalar_t;
...
// islessgreater: VF=double16
// Implement islessgreater directly
__attribute__((__overloadable__))
long16 _cl_islessgreater(double16 x0, double16 x1)
{
  typedef long iscalar_t;
  typedef long jscalar_t;
  typedef int kscalar_t;
