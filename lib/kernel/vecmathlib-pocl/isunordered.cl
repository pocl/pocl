...
// isunordered: VF=half
// Implement isunordered directly
__attribute__((__overloadable__))
int _cl_isunordered(half x0, half x1)
{
...
// isunordered: VF=half2
// Implement isunordered directly
__attribute__((__overloadable__))
short2 _cl_isunordered(half2 x0, half2 x1)
{
  typedef short iscalar_t;
...
// isunordered: VF=half3
// Implement isunordered directly
__attribute__((__overloadable__))
short3 _cl_isunordered(half3 x0, half3 x1)
{
  typedef short iscalar_t;
  typedef short jscalar_t;
  typedef int kscalar_t;
...
// isunordered: VF=half4
// Implement isunordered directly
__attribute__((__overloadable__))
short4 _cl_isunordered(half4 x0, half4 x1)
{
  typedef short iscalar_t;
  typedef short jscalar_t;
  typedef int kscalar_t;
...
// isunordered: VF=half8
// Implement isunordered directly
__attribute__((__overloadable__))
short8 _cl_isunordered(half8 x0, half8 x1)
{
  typedef short iscalar_t;
  typedef short jscalar_t;
  typedef int kscalar_t;
...
// isunordered: VF=half16
// Implement isunordered directly
__attribute__((__overloadable__))
short16 _cl_isunordered(half16 x0, half16 x1)
{
  typedef short iscalar_t;
  typedef short jscalar_t;
  typedef int kscalar_t;
...
// isunordered: VF=float
// Implement isunordered directly
__attribute__((__overloadable__))
int _cl_isunordered(float x0, float x1)
{
...
// isunordered: VF=float2
// Implement isunordered directly
__attribute__((__overloadable__))
int2 _cl_isunordered(float2 x0, float2 x1)
{
  typedef int iscalar_t;
  typedef int jscalar_t;
  typedef int kscalar_t;
...
// isunordered: VF=float3
// Implement isunordered directly
__attribute__((__overloadable__))
int3 _cl_isunordered(float3 x0, float3 x1)
{
  typedef int iscalar_t;
  typedef int jscalar_t;
  typedef int kscalar_t;
...
// isunordered: VF=float4
// Implement isunordered directly
__attribute__((__overloadable__))
int4 _cl_isunordered(float4 x0, float4 x1)
{
  typedef int iscalar_t;
  typedef int jscalar_t;
  typedef int kscalar_t;
...
// isunordered: VF=float8
// Implement isunordered directly
__attribute__((__overloadable__))
int8 _cl_isunordered(float8 x0, float8 x1)
{
  typedef int iscalar_t;
  typedef int jscalar_t;
  typedef int kscalar_t;
...
// isunordered: VF=float16
// Implement isunordered directly
__attribute__((__overloadable__))
int16 _cl_isunordered(float16 x0, float16 x1)
{
  typedef int iscalar_t;
  typedef int jscalar_t;
  typedef int kscalar_t;
...
// isunordered: VF=double
// Implement isunordered directly
__attribute__((__overloadable__))
int _cl_isunordered(double x0, double x1)
{
...
// isunordered: VF=double2
// Implement isunordered directly
__attribute__((__overloadable__))
long2 _cl_isunordered(double2 x0, double2 x1)
{
  typedef long iscalar_t;
...
// isunordered: VF=double3
// Implement isunordered directly
__attribute__((__overloadable__))
long3 _cl_isunordered(double3 x0, double3 x1)
{
  typedef long iscalar_t;
  typedef long jscalar_t;
  typedef int kscalar_t;
...
// isunordered: VF=double4
// Implement isunordered directly
__attribute__((__overloadable__))
long4 _cl_isunordered(double4 x0, double4 x1)
{
  typedef long iscalar_t;
  typedef long jscalar_t;
  typedef int kscalar_t;
...
// isunordered: VF=double8
// Implement isunordered directly
__attribute__((__overloadable__))
long8 _cl_isunordered(double8 x0, double8 x1)
{
  typedef long iscalar_t;
  typedef long jscalar_t;
  typedef int kscalar_t;
...
// isunordered: VF=double16
// Implement isunordered directly
__attribute__((__overloadable__))
long16 _cl_isunordered(double16 x0, double16 x1)
{
  typedef long iscalar_t;
  typedef long jscalar_t;
  typedef int kscalar_t;
