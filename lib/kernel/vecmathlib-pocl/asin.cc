...
// Implement asin by calling vecmathlib
half _cl_asin(half x0)
{
  vecmathlib::realvec<half,1> y0 = bitcast<half,vecmathlib::realvec<half,1> >(x0);
  vecmathlib::realvec<half,1> r = vecmathlib::asin(y0);
  return bitcast<vecmathlib::realvec<half,1>,half>((r));
}
#elif ! defined POCL_VECMATHLIB_BUILTIN
// Implement asin by calling libm
half _cl_asin(half x0)
{
  vecmathlib::realpseudovec<half,1> y0 = x0;
  vecmathlib::realpseudovec<half,1> r = asin(y0);
  return (r)[0];
}
#else
// Implement asin by calling builtin
half _cl_asin(half x0)
{
  vecmathlib::realbuiltinvec<half,1> y0 = x0;
  vecmathlib::realbuiltinvec<half,1> r = asin(y0);
  return (r)[0];
}
#endif
...
// Implement asin by using a larger vector size
half4 _cl_asin(half4);
half2 _cl_asin(half2 x0)
{
...
#else
// Implement asin by splitting into a smaller vector size
half _cl_asin(half);
half2 _cl_asin(half2 x0)
{
...
float _cl_asin(float x0)
{
  ...
  vecmathlib::realpseudovec<float,1> r = asin(y0);
  return (r)[0];
}
#else
// Implement asin by calling builtin
float _cl_asin(float x0)
{
  ...
  vecmathlib::realbuiltinvec<float,1> r = asin(y0);
  return (r)[0];
}
#endif
...
float2 _cl_asin(float2 x0)
{
  ...
  float4 r = _cl_asin(y0);
  return bitcast<float4,float2>(r);
}
#else
// Implement asin by splitting into a smaller vector size
float _cl_asin(float);
float2 _cl_asin(float2 x0)
{
...
// Implement asin by using a larger vector size
float8 _cl_asin(float8);
float4 _cl_asin(float4 x0)
{
  float8 y0 = bitcast<float4,float8>(x0);
  float8 r = _cl_asin(y0);
...
// Implement asin by using a larger vector size
float16 _cl_asin(float16);
float8 _cl_asin(float8 x0)
{
  float16 y0 = bitcast<float8,float16>(x0);
  float16 r = _cl_asin(y0);
...
double _cl_asin(double x0)
{
  ...
  vecmathlib::realpseudovec<double,1> r = asin(y0);
  return (r)[0];
}
#else
// Implement asin by calling builtin
double _cl_asin(double x0)
{
  ...
  vecmathlib::realbuiltinvec<double,1> r = asin(y0);
  return (r)[0];
}
#endif
...
double2 _cl_asin(double2 x0)
{
  ...
  double4 r = _cl_asin(y0);
  return bitcast<double4,double2>(r);
}
#else
// Implement asin by splitting into a smaller vector size
double _cl_asin(double);
double2 _cl_asin(double2 x0)
{
...
// Implement asin by using a larger vector size
double8 _cl_asin(double8);
double4 _cl_asin(double4 x0)
{
  double8 y0 = bitcast<double4,double8>(x0);
  double8 r = _cl_asin(y0);
...
// Implement asin by using a larger vector size
double16 _cl_asin(double16);
double8 _cl_asin(double8 x0)
{
  double16 y0 = bitcast<double8,double16>(x0);
  double16 r = _cl_asin(y0);
