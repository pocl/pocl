...
// acospi: VF=half
// Implement acospi directly
__attribute__((__overloadable__))
half _cl_acospi(half x0)
{
...
#define ldexp_vector_ _cl_ldexp_half_short
  return acos(x0)/TYPED_CONST(scalar_t, M_PI_H, M_PI_F, M_PI);
...
// Implement acospi directly
__attribute__((__overloadable__))
double16 _cl_acospi(double16 x0)
{
  typedef long iscalar_t;
  typedef long jscalar_t;
  typedef int kscalar_t;
