...
half _cl_rint(half x0)
{
  ...
  vecmathlib::realpseudovec<half,1> r = rint(y0);
  return (r)[0];
}
#else
...
half _cl_rint(half x0)
{
  ...
  vecmathlib::realbuiltinvec<half,1> r = rint(y0);
  return (r)[0];
}
#endif
