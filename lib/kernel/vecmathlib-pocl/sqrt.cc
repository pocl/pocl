...
// Implement sqrt by calling vecmathlib
half _cl_sqrt(half x0)
{
  vecmathlib::realvec<half,1> y0 = bitcast<half,vecmathlib::realvec<half,1> >(x0);
  vecmathlib::realvec<half,1> r = vecmathlib::sqrt(y0);
  return bitcast<vecmathlib::realvec<half,1>,half>((r));
}
#elif ! defined POCL_VECMATHLIB_BUILTIN
// Implement sqrt by calling libm
half _cl_sqrt(half x0)
{
  vecmathlib::realpseudovec<half,1> y0 = x0;
  vecmathlib::realpseudovec<half,1> r = sqrt(y0);
  return (r)[0];
}
#else
// Implement sqrt by calling builtin
half _cl_sqrt(half x0)
{
  vecmathlib::realbuiltinvec<half,1> y0 = x0;
  vecmathlib::realbuiltinvec<half,1> r = sqrt(y0);
  return (r)[0];
}
#endif
...
// Implement sqrt by using a larger vector size
half4 _cl_sqrt(half4);
half2 _cl_sqrt(half2 x0)
{
...
#else
// Implement sqrt by splitting into a smaller vector size
half _cl_sqrt(half);
half2 _cl_sqrt(half2 x0)
{
...
float _cl_sqrt(float x0)
{
  ...
  vecmathlib::realpseudovec<float,1> r = sqrt(y0);
  return (r)[0];
}
#else
// Implement sqrt by calling builtin
float _cl_sqrt(float x0)
{
  ...
  vecmathlib::realbuiltinvec<float,1> r = sqrt(y0);
  return (r)[0];
}
#endif
...
float2 _cl_sqrt(float2 x0)
{
  ...
  float4 r = _cl_sqrt(y0);
  return bitcast<float4,float2>(r);
}
#else
// Implement sqrt by splitting into a smaller vector size
float _cl_sqrt(float);
float2 _cl_sqrt(float2 x0)
{
...
// Implement sqrt by using a larger vector size
float8 _cl_sqrt(float8);
float4 _cl_sqrt(float4 x0)
{
  float8 y0 = bitcast<float4,float8>(x0);
  float8 r = _cl_sqrt(y0);
...
// Implement sqrt by using a larger vector size
float16 _cl_sqrt(float16);
float8 _cl_sqrt(float8 x0)
{
  float16 y0 = bitcast<float8,float16>(x0);
  float16 r = _cl_sqrt(y0);
...
double _cl_sqrt(double x0)
{
  ...
  vecmathlib::realpseudovec<double,1> r = sqrt(y0);
  return (r)[0];
}
#else
// Implement sqrt by calling builtin
double _cl_sqrt(double x0)
{
  ...
  vecmathlib::realbuiltinvec<double,1> r = sqrt(y0);
  return (r)[0];
}
#endif
...
double2 _cl_sqrt(double2 x0)
{
  ...
  double4 r = _cl_sqrt(y0);
  return bitcast<double4,double2>(r);
}
#else
// Implement sqrt by splitting into a smaller vector size
double _cl_sqrt(double);
double2 _cl_sqrt(double2 x0)
{
...
// Implement sqrt by using a larger vector size
double8 _cl_sqrt(double8);
double4 _cl_sqrt(double4 x0)
{
  double8 y0 = bitcast<double4,double8>(x0);
  double8 r = _cl_sqrt(y0);
...
// Implement sqrt by using a larger vector size
double16 _cl_sqrt(double16);
double8 _cl_sqrt(double8 x0)
{
  double16 y0 = bitcast<double8,double16>(x0);
  double16 r = _cl_sqrt(y0);
