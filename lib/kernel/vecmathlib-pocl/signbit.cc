...
int _cl_signbit(half x0)
{
  vecmathlib::realvec<half,1> y0 = bitcast<half,vecmathlib::realvec<half,1> >(x0);
  vecmathlib::realvec<half,1>::boolvec_t r = vecmathlib::signbit(y0);
...
int _cl_signbit(half x0)
{
  ...
  vecmathlib::realpseudovec<half,1>::boolvec_t r = signbit(y0);
...
int _cl_signbit(half x0)
{
  ...
  vecmathlib::realbuiltinvec<half,1>::boolvec_t r = signbit(y0);
  return vecmathlib::convert_int(r)[0];
}
#endif
...
// Implement signbit by calling vecmathlib
short2 _cl_signbit(half2 x0)
{
  vecmathlib::realvec<half,2> y0 = bitcast<half2,vecmathlib::realvec<half,2> >(x0);
  vecmathlib::realvec<half,2>::boolvec_t r = vecmathlib::signbit(y0);
...
short4 _cl_signbit(half4);
short2 _cl_signbit(half2 x0)
{
  half4 y0 = bitcast<half2,half4>(x0);
  short4 r = _cl_signbit(y0);
  return bitcast<short4,short2>(r);
}
#else
// Implement signbit by splitting into a smaller vector size
int _cl_signbit(half);
short2 _cl_signbit(half2 x0)
{
  pair_half y0 = bitcast<half2,pair_half>(x0);
  pair_short r;
  r.lo = -_cl_signbit(y0.lo);
  r.hi = -_cl_signbit(y0.hi);
...
// Implement signbit by calling vecmathlib
short3 _cl_signbit(half3 x0)
{
  vecmathlib::realvec<half,3> y0 = bitcast<half3,vecmathlib::realvec<half,3> >(x0);
  vecmathlib::realvec<half,3>::boolvec_t r = vecmathlib::signbit(y0);
...
// Implement signbit by calling vecmathlib
short4 _cl_signbit(half4 x0)
{
  vecmathlib::realvec<half,4> y0 = bitcast<half4,vecmathlib::realvec<half,4> >(x0);
  vecmathlib::realvec<half,4>::boolvec_t r = vecmathlib::signbit(y0);
...
// Implement signbit by using a larger vector size
short8 _cl_signbit(half8);
short4 _cl_signbit(half4 x0)
{
  half8 y0 = bitcast<half4,half8>(x0);
  short8 r = _cl_signbit(y0);
...
// Implement signbit by calling vecmathlib
short8 _cl_signbit(half8 x0)
{
  vecmathlib::realvec<half,8> y0 = bitcast<half8,vecmathlib::realvec<half,8> >(x0);
  vecmathlib::realvec<half,8>::boolvec_t r = vecmathlib::signbit(y0);
...
// Implement signbit by using a larger vector size
short16 _cl_signbit(half16);
short8 _cl_signbit(half8 x0)
{
  half16 y0 = bitcast<half8,half16>(x0);
  short16 r = _cl_signbit(y0);
...
// Implement signbit by calling vecmathlib
short16 _cl_signbit(half16 x0)
{
  vecmathlib::realvec<half,16> y0 = bitcast<half16,vecmathlib::realvec<half,16> >(x0);
  vecmathlib::realvec<half,16>::boolvec_t r = vecmathlib::signbit(y0);
...
int2 _cl_signbit(float2 x0)
{
  ...
  int4 r = _cl_signbit(y0);
  return bitcast<int4,int2>(r);
}
#else
// Implement signbit by splitting into a smaller vector size
int _cl_signbit(float);
int2 _cl_signbit(float2 x0)
{
...
int16 _cl_signbit(float16 x0)
{
  ...
  vecmathlib::realvec<float,16>::boolvec_t r = vecmathlib::signbit(y0);
...
long2 _cl_signbit(double2 x0)
{
  ...
  long4 r = _cl_signbit(y0);
  return bitcast<long4,long2>(r);
}
#else
// Implement signbit by splitting into a smaller vector size
int _cl_signbit(double);
long2 _cl_signbit(double2 x0)
{
...
long16 _cl_signbit(double16 x0)
{
  ...
  vecmathlib::realvec<double,16>::boolvec_t r = vecmathlib::signbit(y0);
