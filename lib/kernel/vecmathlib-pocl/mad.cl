...
half _cl_mad(half x0, half x1, half x2)
{
...
// Implement mad directly
__attribute__((__overloadable__))
half2 _cl_mad(half2 x0, half2 x1, half2 x2)
{
  typedef short iscalar_t;
...
// Implement mad directly
__attribute__((__overloadable__))
half3 _cl_mad(half3 x0, half3 x1, half3 x2)
{
  typedef short iscalar_t;
  typedef short jscalar_t;
  typedef int kscalar_t;
...
// Implement mad directly
__attribute__((__overloadable__))
half4 _cl_mad(half4 x0, half4 x1, half4 x2)
{
  typedef short iscalar_t;
  typedef short jscalar_t;
  typedef int kscalar_t;
...
// Implement mad directly
__attribute__((__overloadable__))
half8 _cl_mad(half8 x0, half8 x1, half8 x2)
{
  typedef short iscalar_t;
  typedef short jscalar_t;
  typedef int kscalar_t;
...
// Implement mad directly
__attribute__((__overloadable__))
half16 _cl_mad(half16 x0, half16 x1, half16 x2)
{
  typedef short iscalar_t;
  typedef short jscalar_t;
  typedef int kscalar_t;
