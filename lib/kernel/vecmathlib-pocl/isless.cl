...
int _cl_isless(half x0, half x1)
{
...
// Implement isless directly
__attribute__((__overloadable__))
short2 _cl_isless(half2 x0, half2 x1)
{
  typedef short iscalar_t;
...
// Implement isless directly
__attribute__((__overloadable__))
short3 _cl_isless(half3 x0, half3 x1)
{
  typedef short iscalar_t;
  typedef short jscalar_t;
  typedef int kscalar_t;
...
// Implement isless directly
__attribute__((__overloadable__))
short4 _cl_isless(half4 x0, half4 x1)
{
  typedef short iscalar_t;
  typedef short jscalar_t;
  typedef int kscalar_t;
...
// Implement isless directly
__attribute__((__overloadable__))
short8 _cl_isless(half8 x0, half8 x1)
{
  typedef short iscalar_t;
  typedef short jscalar_t;
  typedef int kscalar_t;
...
// Implement isless directly
__attribute__((__overloadable__))
short16 _cl_isless(half16 x0, half16 x1)
{
  typedef short iscalar_t;
  typedef short jscalar_t;
  typedef int kscalar_t;
