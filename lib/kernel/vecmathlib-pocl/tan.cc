...
half _cl_tan(half x0)
{
  ...
  vecmathlib::realpseudovec<half,1> r = tan(y0);
  return (r)[0];
}
#else
// Implement tan by calling builtin
half _cl_tan(half x0)
{
  vecmathlib::realbuiltinvec<half,1> y0 = x0;
  vecmathlib::realbuiltinvec<half,1> r = tan(y0);
  return (r)[0];
}
#endif
...
float _cl_tan(float x0)
{
  ...
  vecmathlib::realbuiltinvec<float,1> r = tan(y0);
  return (r)[0];
}
#endif
...
double _cl_tan(double x0)
{
  ...
  vecmathlib::realbuiltinvec<double,1> r = tan(y0);
  return (r)[0];
}
#endif
