...
half _cl_atan(half x0)
{
  ...
  vecmathlib::realpseudovec<half,1> r = atan(y0);
  return (r)[0];
}
#else
// Implement atan by calling builtin
half _cl_atan(half x0)
{
  vecmathlib::realbuiltinvec<half,1> y0 = x0;
  vecmathlib::realbuiltinvec<half,1> r = atan(y0);
  return (r)[0];
}
#endif
...
float _cl_atan(float x0)
{
  ...
  vecmathlib::realbuiltinvec<float,1> r = atan(y0);
  return (r)[0];
}
#endif
...
double _cl_atan(double x0)
{
  ...
  vecmathlib::realbuiltinvec<double,1> r = atan(y0);
  return (r)[0];
}
#endif
