...
// isordered: VF=half
// Implement isordered directly
__attribute__((__overloadable__))
int _cl_isordered(half x0, half x1)
{
...
// Implement isordered directly
__attribute__((__overloadable__))
short2 _cl_isordered(half2 x0, half2 x1)
{
  typedef short iscalar_t;
...
// Implement isordered directly
__attribute__((__overloadable__))
short3 _cl_isordered(half3 x0, half3 x1)
{
  typedef short iscalar_t;
  typedef short jscalar_t;
  typedef int kscalar_t;
...
// Implement isordered directly
__attribute__((__overloadable__))
short4 _cl_isordered(half4 x0, half4 x1)
{
  typedef short iscalar_t;
  typedef short jscalar_t;
  typedef int kscalar_t;
...
// Implement isordered directly
__attribute__((__overloadable__))
short8 _cl_isordered(half8 x0, half8 x1)
{
  typedef short iscalar_t;
  typedef short jscalar_t;
  typedef int kscalar_t;
...
// Implement isordered directly
__attribute__((__overloadable__))
short16 _cl_isordered(half16 x0, half16 x1)
{
  typedef short iscalar_t;
  typedef short jscalar_t;
  typedef int kscalar_t;
...
// Implement isordered directly
__attribute__((__overloadable__))
int _cl_isordered(float x0, float x1)
{
...
// Implement isordered directly
__attribute__((__overloadable__))
int2 _cl_isordered(float2 x0, float2 x1)
{
  typedef int iscalar_t;
  typedef int jscalar_t;
  typedef int kscalar_t;
...
// Implement isordered directly
__attribute__((__overloadable__))
int3 _cl_isordered(float3 x0, float3 x1)
{
  typedef int iscalar_t;
  typedef int jscalar_t;
  typedef int kscalar_t;
...
// Implement isordered directly
__attribute__((__overloadable__))
int4 _cl_isordered(float4 x0, float4 x1)
{
  typedef int iscalar_t;
  typedef int jscalar_t;
  typedef int kscalar_t;
...
// Implement isordered directly
__attribute__((__overloadable__))
int8 _cl_isordered(float8 x0, float8 x1)
{
  typedef int iscalar_t;
  typedef int jscalar_t;
  typedef int kscalar_t;
...
// isordered: VF=float16
// Implement isordered directly
__attribute__((__overloadable__))
int16 _cl_isordered(float16 x0, float16 x1)
{
  typedef int iscalar_t;
  typedef int jscalar_t;
  typedef int kscalar_t;
...
// Implement isordered directly
__attribute__((__overloadable__))
int _cl_isordered(double x0, double x1)
{
...
// isordered: VF=double2
// Implement isordered directly
__attribute__((__overloadable__))
long2 _cl_isordered(double2 x0, double2 x1)
{
  typedef long iscalar_t;
...
// isordered: VF=double3
// Implement isordered directly
__attribute__((__overloadable__))
long3 _cl_isordered(double3 x0, double3 x1)
{
  typedef long iscalar_t;
  typedef long jscalar_t;
  typedef int kscalar_t;
...
// isordered: VF=double4
// Implement isordered directly
__attribute__((__overloadable__))
long4 _cl_isordered(double4 x0, double4 x1)
{
  typedef long iscalar_t;
  typedef long jscalar_t;
  typedef int kscalar_t;
...
// isordered: VF=double8
// Implement isordered directly
__attribute__((__overloadable__))
long8 _cl_isordered(double8 x0, double8 x1)
{
  typedef long iscalar_t;
  typedef long jscalar_t;
  typedef int kscalar_t;
...
// isordered: VF=double16
// Implement isordered directly
__attribute__((__overloadable__))
long16 _cl_isordered(double16 x0, double16 x1)
{
  typedef long iscalar_t;
  typedef long jscalar_t;
  typedef int kscalar_t;
