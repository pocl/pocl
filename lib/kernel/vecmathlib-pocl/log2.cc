...
// Implement log2 by calling vecmathlib
half _cl_log2(half x0)
{
  vecmathlib::realvec<half,1> y0 = bitcast<half,vecmathlib::realvec<half,1> >(x0);
  vecmathlib::realvec<half,1> r = vecmathlib::log2(y0);
  return bitcast<vecmathlib::realvec<half,1>,half>((r));
}
#elif ! defined POCL_VECMATHLIB_BUILTIN
// Implement log2 by calling libm
half _cl_log2(half x0)
{
  vecmathlib::realpseudovec<half,1> y0 = x0;
  vecmathlib::realpseudovec<half,1> r = log2(y0);
  return (r)[0];
}
#else
// Implement log2 by calling builtin
half _cl_log2(half x0)
{
  vecmathlib::realbuiltinvec<half,1> y0 = x0;
  vecmathlib::realbuiltinvec<half,1> r = log2(y0);
  return (r)[0];
}
#endif
...
// Implement log2 by using a larger vector size
half4 _cl_log2(half4);
half2 _cl_log2(half2 x0)
{
...
#else
// Implement log2 by splitting into a smaller vector size
half _cl_log2(half);
half2 _cl_log2(half2 x0)
{
...
float _cl_log2(float x0)
{
  ...
  vecmathlib::realpseudovec<float,1> r = log2(y0);
  return (r)[0];
}
#else
// Implement log2 by calling builtin
float _cl_log2(float x0)
{
  ...
  vecmathlib::realbuiltinvec<float,1> r = log2(y0);
  return (r)[0];
}
#endif
...
// Implement log2 by using a larger vector size
float8 _cl_log2(float8);
float4 _cl_log2(float4 x0)
{
  float8 y0 = bitcast<float4,float8>(x0);
  float8 r = _cl_log2(y0);
...
// Implement log2 by using a larger vector size
float16 _cl_log2(float16);
float8 _cl_log2(float8 x0)
{
  float16 y0 = bitcast<float8,float16>(x0);
  float16 r = _cl_log2(y0);
...
double _cl_log2(double x0)
{
  ...
  vecmathlib::realpseudovec<double,1> r = log2(y0);
  return (r)[0];
}
#else
// Implement log2 by calling builtin
double _cl_log2(double x0)
{
  ...
  vecmathlib::realbuiltinvec<double,1> r = log2(y0);
  return (r)[0];
}
#endif
...
// Implement log2 by using a larger vector size
double8 _cl_log2(double8);
double4 _cl_log2(double4 x0)
{
  double8 y0 = bitcast<double4,double8>(x0);
  double8 r = _cl_log2(y0);
...
// Implement log2 by using a larger vector size
double16 _cl_log2(double16);
double8 _cl_log2(double8 x0)
{
  double16 y0 = bitcast<double8,double16>(x0);
  double16 r = _cl_log2(y0);
