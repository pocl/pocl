...
int _cl_islessequal(half x0, half x1)
{
...
// islessequal: VF=half2
// Implement islessequal directly
__attribute__((__overloadable__))
short2 _cl_islessequal(half2 x0, half2 x1)
{
  typedef short iscalar_t;
...
// islessequal: VF=half3
// Implement islessequal directly
__attribute__((__overloadable__))
short3 _cl_islessequal(half3 x0, half3 x1)
{
  typedef short iscalar_t;
  typedef short jscalar_t;
  typedef int kscalar_t;
...
// islessequal: VF=half4
// Implement islessequal directly
__attribute__((__overloadable__))
short4 _cl_islessequal(half4 x0, half4 x1)
{
  typedef short iscalar_t;
  typedef short jscalar_t;
  typedef int kscalar_t;
...
// islessequal: VF=half8
// Implement islessequal directly
__attribute__((__overloadable__))
short8 _cl_islessequal(half8 x0, half8 x1)
{
  typedef short iscalar_t;
  typedef short jscalar_t;
  typedef int kscalar_t;
...
// islessequal: VF=half16
// Implement islessequal directly
__attribute__((__overloadable__))
short16 _cl_islessequal(half16 x0, half16 x1)
{
  typedef short iscalar_t;
  typedef short jscalar_t;
  typedef int kscalar_t;
