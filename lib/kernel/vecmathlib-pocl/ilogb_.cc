...
extern "C" short _cl_ilogb_half(half x0)
{
...
// Implement ilogb_ by calling vecmathlib
extern "C" short2 _cl_ilogb_half2(half2 x0)
{
...
// Implement ilogb_ by calling vecmathlib
extern "C" short3 _cl_ilogb_half3(half3 x0)
{
...
#else
// Implement ilogb_ by splitting into a smaller vector size
extern "C" short2 _cl_ilogb_half2(half2);
extern "C" short3 _cl_ilogb_half3(half3 x0)
{
  pair_half2 y0 = bitcast<half3,pair_half2>(x0);
  pair_short2 r;
  r.lo = _cl_ilogb_half2(y0.lo);
  r.hi = _cl_ilogb_half2(y0.hi);
...
// Implement ilogb_ by calling vecmathlib
extern "C" short4 _cl_ilogb_half4(half4 x0)
{
...
// Implement ilogb_ by using a larger vector size
extern "C" short8 _cl_ilogb_half8(half8);
extern "C" short4 _cl_ilogb_half4(half4 x0)
{
  half8 y0 = bitcast<half4,half8>(x0);
  short8 r = _cl_ilogb_half8(y0);
...
// Implement ilogb_ by calling vecmathlib
extern "C" short8 _cl_ilogb_half8(half8 x0)
{
...
// Implement ilogb_ by using a larger vector size
extern "C" short16 _cl_ilogb_half16(half16);
extern "C" short8 _cl_ilogb_half8(half8 x0)
{
  half16 y0 = bitcast<half8,half16>(x0);
  short16 r = _cl_ilogb_half16(y0);
...
extern "C" short8 _cl_ilogb_half8(half8 x0)
{
  ...
  pair_short4 r;
  r.lo = _cl_ilogb_half4(y0.lo);
  r.hi = _cl_ilogb_half4(y0.hi);
...
// Implement ilogb_ by calling vecmathlib
extern "C" short16 _cl_ilogb_half16(half16 x0)
{
...
extern "C" short16 _cl_ilogb_half16(half16 x0)
{
  ...
  pair_short8 r;
  r.lo = _cl_ilogb_half8(y0.lo);
  r.hi = _cl_ilogb_half8(y0.hi);
...
// Implement ilogb_ by calling vecmathlib
extern "C" int _cl_ilogb_float(float x0)
{
...
// Implement ilogb_ by calling vecmathlib
extern "C" int2 _cl_ilogb_float2(float2 x0)
{
...
// Implement ilogb_ by using a larger vector size
extern "C" int4 _cl_ilogb_float4(float4);
extern "C" int2 _cl_ilogb_float2(float2 x0)
{
  float4 y0 = bitcast<float2,float4>(x0);
  int4 r = _cl_ilogb_float4(y0);
  return bitcast<int4,int2>(r);
}
#else
// Implement ilogb_ by splitting into a smaller vector size
extern "C" int _cl_ilogb_float(float);
extern "C" int2 _cl_ilogb_float2(float2 x0)
{
  pair_float y0 = bitcast<float2,pair_float>(x0);
  pair_int r;
  r.lo = _cl_ilogb_float(y0.lo);
  r.hi = _cl_ilogb_float(y0.hi);
...
// Implement ilogb_ by calling vecmathlib
extern "C" int3 _cl_ilogb_float3(float3 x0)
{
...
#else
// Implement ilogb_ by splitting into a smaller vector size
extern "C" int2 _cl_ilogb_float2(float2);
extern "C" int3 _cl_ilogb_float3(float3 x0)
{
  pair_float2 y0 = bitcast<float3,pair_float2>(x0);
  pair_int2 r;
  r.lo = _cl_ilogb_float2(y0.lo);
  r.hi = _cl_ilogb_float2(y0.hi);
...
// Implement ilogb_ by calling vecmathlib
extern "C" int4 _cl_ilogb_float4(float4 x0)
{
...
// Implement ilogb_ by using a larger vector size
extern "C" int8 _cl_ilogb_float8(float8);
extern "C" int4 _cl_ilogb_float4(float4 x0)
{
  float8 y0 = bitcast<float4,float8>(x0);
  int8 r = _cl_ilogb_float8(y0);
...
// Implement ilogb_ by calling vecmathlib
extern "C" int8 _cl_ilogb_float8(float8 x0)
{
...
// Implement ilogb_ by using a larger vector size
extern "C" int16 _cl_ilogb_float16(float16);
extern "C" int8 _cl_ilogb_float8(float8 x0)
{
  float16 y0 = bitcast<float8,float16>(x0);
  int16 r = _cl_ilogb_float16(y0);
...
extern "C" int8 _cl_ilogb_float8(float8 x0)
{
  ...
  pair_int4 r;
  r.lo = _cl_ilogb_float4(y0.lo);
  r.hi = _cl_ilogb_float4(y0.hi);
...
// Implement ilogb_ by calling vecmathlib
extern "C" int16 _cl_ilogb_float16(float16 x0)
{
...
extern "C" int16 _cl_ilogb_float16(float16 x0)
{
  ...
  pair_int8 r;
  r.lo = _cl_ilogb_float8(y0.lo);
  r.hi = _cl_ilogb_float8(y0.hi);
...
// Implement ilogb_ by calling vecmathlib
extern "C" long _cl_ilogb_double(double x0)
{
...
// Implement ilogb_ by calling vecmathlib
extern "C" long2 _cl_ilogb_double2(double2 x0)
{
...
// Implement ilogb_ by using a larger vector size
extern "C" long4 _cl_ilogb_double4(double4);
extern "C" long2 _cl_ilogb_double2(double2 x0)
{
  double4 y0 = bitcast<double2,double4>(x0);
  long4 r = _cl_ilogb_double4(y0);
  return bitcast<long4,long2>(r);
}
#else
// Implement ilogb_ by splitting into a smaller vector size
extern "C" long _cl_ilogb_double(double);
extern "C" long2 _cl_ilogb_double2(double2 x0)
{
  pair_double y0 = bitcast<double2,pair_double>(x0);
  pair_long r;
  r.lo = _cl_ilogb_double(y0.lo);
  r.hi = _cl_ilogb_double(y0.hi);
...
// Implement ilogb_ by calling vecmathlib
extern "C" long3 _cl_ilogb_double3(double3 x0)
{
...
#else
// Implement ilogb_ by splitting into a smaller vector size
extern "C" long2 _cl_ilogb_double2(double2);
extern "C" long3 _cl_ilogb_double3(double3 x0)
{
  pair_double2 y0 = bitcast<double3,pair_double2>(x0);
  pair_long2 r;
  r.lo = _cl_ilogb_double2(y0.lo);
  r.hi = _cl_ilogb_double2(y0.hi);
...
// Implement ilogb_ by calling vecmathlib
extern "C" long4 _cl_ilogb_double4(double4 x0)
{
...
// Implement ilogb_ by using a larger vector size
extern "C" long8 _cl_ilogb_double8(double8);
extern "C" long4 _cl_ilogb_double4(double4 x0)
{
  double8 y0 = bitcast<double4,double8>(x0);
  long8 r = _cl_ilogb_double8(y0);
...
// Implement ilogb_ by calling vecmathlib
extern "C" long8 _cl_ilogb_double8(double8 x0)
{
...
// Implement ilogb_ by using a larger vector size
extern "C" long16 _cl_ilogb_double16(double16);
extern "C" long8 _cl_ilogb_double8(double8 x0)
{
  double16 y0 = bitcast<double8,double16>(x0);
  long16 r = _cl_ilogb_double16(y0);
...
extern "C" long8 _cl_ilogb_double8(double8 x0)
{
  ...
  pair_long4 r;
  r.lo = _cl_ilogb_double4(y0.lo);
  r.hi = _cl_ilogb_double4(y0.hi);
...
// Implement ilogb_ by calling vecmathlib
extern "C" long16 _cl_ilogb_double16(double16 x0)
{
...
extern "C" long16 _cl_ilogb_double16(double16 x0)
{
  ...
  pair_long8 r;
  r.lo = _cl_ilogb_double8(y0.lo);
  r.hi = _cl_ilogb_double8(y0.hi);
