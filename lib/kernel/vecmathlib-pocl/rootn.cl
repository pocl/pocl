...
// Implement rootn directly
__attribute__((__overloadable__))
half2 _cl_rootn(half2 x0, int2 x1)
{
  typedef short iscalar_t;
...
// Implement rootn directly
__attribute__((__overloadable__))
half3 _cl_rootn(half3 x0, int3 x1)
{
  typedef short iscalar_t;
  typedef short jscalar_t;
  typedef int kscalar_t;
...
// Implement rootn directly
__attribute__((__overloadable__))
half4 _cl_rootn(half4 x0, int4 x1)
{
  typedef short iscalar_t;
  typedef short jscalar_t;
  typedef int kscalar_t;
...
// Implement rootn directly
__attribute__((__overloadable__))
half8 _cl_rootn(half8 x0, int8 x1)
{
  typedef short iscalar_t;
  typedef short jscalar_t;
  typedef int kscalar_t;
...
// Implement rootn directly
__attribute__((__overloadable__))
half16 _cl_rootn(half16 x0, int16 x1)
{
  typedef short iscalar_t;
  typedef short jscalar_t;
  typedef int kscalar_t;
