...
half _cl_sin(half x0)
{
  ...
  vecmathlib::realpseudovec<half,1> r = sin(y0);
  return (r)[0];
}
#else
// Implement sin by calling builtin
half _cl_sin(half x0)
{
  vecmathlib::realbuiltinvec<half,1> y0 = x0;
  vecmathlib::realbuiltinvec<half,1> r = sin(y0);
  return (r)[0];
}
#endif
...
float _cl_sin(float x0)
{
  ...
  vecmathlib::realbuiltinvec<float,1> r = sin(y0);
  return (r)[0];
}
#endif
...
double _cl_sin(double x0)
{
  ...
  vecmathlib::realbuiltinvec<double,1> r = sin(y0);
  return (r)[0];
}
#endif
