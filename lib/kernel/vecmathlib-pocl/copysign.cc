...
// Implement copysign by calling vecmathlib
half _cl_copysign(half x0, half x1)
{
...
// Implement copysign by calling vecmathlib
half2 _cl_copysign(half2 x0, half2 x1)
{
  ...
  vecmathlib::realvec<half,2> r = vecmathlib::copysign(y0, y1);
...
// Implement copysign by using a larger vector size
half4 _cl_copysign(half4, half4);
half2 _cl_copysign(half2 x0, half2 x1)
{
  half4 y0 = bitcast<half2,half4>(x0);
  half4 y1 = bitcast<half2,half4>(x1);
  half4 r = _cl_copysign(y0, y1);
  return bitcast<half4,half2>(r);
}
#else
// Implement copysign by splitting into a smaller vector size
half _cl_copysign(half, half);
half2 _cl_copysign(half2 x0, half2 x1)
{
  pair_half y0 = bitcast<half2,pair_half>(x0);
  pair_half y1 = bitcast<half2,pair_half>(x1);
  pair_half r;
  r.lo = _cl_copysign(y0.lo, y1.lo);
  r.hi = _cl_copysign(y0.hi, y1.hi);
...
// Implement copysign by calling vecmathlib
half3 _cl_copysign(half3 x0, half3 x1)
{
  ...
  vecmathlib::realvec<half,3> r = vecmathlib::copysign(y0, y1);
...
#else
// Implement copysign by splitting into a smaller vector size
half2 _cl_copysign(half2, half2);
half3 _cl_copysign(half3 x0, half3 x1)
{
...
// Implement copysign by calling vecmathlib
half4 _cl_copysign(half4 x0, half4 x1)
{
  ...
  vecmathlib::realvec<half,4> r = vecmathlib::copysign(y0, y1);
...
// Implement copysign by calling vecmathlib
half8 _cl_copysign(half8 x0, half8 x1)
{
...
// Implement copysign by calling vecmathlib
half16 _cl_copysign(half16 x0, half16 x1)
{
  ...
  vecmathlib::realvec<half,16> r = vecmathlib::copysign(y0, y1);
...
// Implement copysign by calling vecmathlib
float _cl_copysign(float x0, float x1)
{
  ...
  vecmathlib::realvec<float,1> r = vecmathlib::copysign(y0, y1);
...
float _cl_copysign(float x0, float x1)
{
  ...
  vecmathlib::realpseudovec<float,1> r = copysign(y0, y1);
  return (r)[0];
}
#else
// Implement copysign by calling builtin
float _cl_copysign(float x0, float x1)
{
  ...
  vecmathlib::realbuiltinvec<float,1> r = copysign(y0, y1);
  return (r)[0];
}
#endif
...
// Implement copysign by calling vecmathlib
float2 _cl_copysign(float2 x0, float2 x1)
{
  ...
  vecmathlib::realvec<float,2> r = vecmathlib::copysign(y0, y1);
...
float2 _cl_copysign(float2 x0, float2 x1)
{
  ...
  float4 r = _cl_copysign(y0, y1);
  return bitcast<float4,float2>(r);
}
#else
// Implement copysign by splitting into a smaller vector size
float _cl_copysign(float, float);
float2 _cl_copysign(float2 x0, float2 x1)
{
...
// Implement copysign by calling vecmathlib
float3 _cl_copysign(float3 x0, float3 x1)
{
  ...
  vecmathlib::realvec<float,3> r = vecmathlib::copysign(y0, y1);
...
#else
// Implement copysign by splitting into a smaller vector size
float2 _cl_copysign(float2, float2);
float3 _cl_copysign(float3 x0, float3 x1)
{
...
// Implement copysign by calling vecmathlib
float4 _cl_copysign(float4 x0, float4 x1)
{
  ...
  vecmathlib::realvec<float,4> r = vecmathlib::copysign(y0, y1);
...
// Implement copysign by calling vecmathlib
float8 _cl_copysign(float8 x0, float8 x1)
{
  ...
  vecmathlib::realvec<float,8> r = vecmathlib::copysign(y0, y1);
...
// Implement copysign by calling vecmathlib
float16 _cl_copysign(float16 x0, float16 x1)
{
  ...
  vecmathlib::realvec<float,16> r = vecmathlib::copysign(y0, y1);
...
// Implement copysign by calling vecmathlib
double _cl_copysign(double x0, double x1)
{
  ...
  vecmathlib::realvec<double,1> r = vecmathlib::copysign(y0, y1);
...
double _cl_copysign(double x0, double x1)
{
  ...
  vecmathlib::realpseudovec<double,1> r = copysign(y0, y1);
  return (r)[0];
}
#else
// Implement copysign by calling builtin
double _cl_copysign(double x0, double x1)
{
  ...
  vecmathlib::realbuiltinvec<double,1> r = copysign(y0, y1);
  return (r)[0];
}
#endif
...
// Implement copysign by calling vecmathlib
double2 _cl_copysign(double2 x0, double2 x1)
{
  ...
  vecmathlib::realvec<double,2> r = vecmathlib::copysign(y0, y1);
...
double2 _cl_copysign(double2 x0, double2 x1)
{
  ...
  double4 r = _cl_copysign(y0, y1);
  return bitcast<double4,double2>(r);
}
#else
// Implement copysign by splitting into a smaller vector size
double _cl_copysign(double, double);
double2 _cl_copysign(double2 x0, double2 x1)
{
...
// Implement copysign by calling vecmathlib
double3 _cl_copysign(double3 x0, double3 x1)
{
  ...
  vecmathlib::realvec<double,3> r = vecmathlib::copysign(y0, y1);
...
#else
// Implement copysign by splitting into a smaller vector size
double2 _cl_copysign(double2, double2);
double3 _cl_copysign(double3 x0, double3 x1)
{
...
// Implement copysign by calling vecmathlib
double4 _cl_copysign(double4 x0, double4 x1)
{
  ...
  vecmathlib::realvec<double,4> r = vecmathlib::copysign(y0, y1);
...
// Implement copysign by calling vecmathlib
double8 _cl_copysign(double8 x0, double8 x1)
{
  ...
  vecmathlib::realvec<double,8> r = vecmathlib::copysign(y0, y1);
...
double16 _cl_copysign(double16 x0, double16 x1)
{
  ...
  vecmathlib::realvec<double,16> r = vecmathlib::copysign(y0, y1);
