...
// minmag: VF=half
// Implement minmag directly
__attribute__((__overloadable__))
half _cl_minmag(half x0, half x1)
{
...
#define ldexp_vector_ _cl_ldexp_half_short
  return fabs(x0)<fabs(x1) ? x0 : fabs(x1)<fabs(x0) ? x1 : fmin(x0,x1);
...
// Implement minmag directly
__attribute__((__overloadable__))
half2 _cl_minmag(half2 x0, half2 x1)
{
  typedef short iscalar_t;
...
// Implement minmag directly
__attribute__((__overloadable__))
half3 _cl_minmag(half3 x0, half3 x1)
{
  typedef short iscalar_t;
  typedef short jscalar_t;
  typedef int kscalar_t;
...
// Implement minmag directly
__attribute__((__overloadable__))
half4 _cl_minmag(half4 x0, half4 x1)
{
  typedef short iscalar_t;
  typedef short jscalar_t;
  typedef int kscalar_t;
...
// Implement minmag directly
__attribute__((__overloadable__))
half8 _cl_minmag(half8 x0, half8 x1)
{
  typedef short iscalar_t;
  typedef short jscalar_t;
  typedef int kscalar_t;
...
// Implement minmag directly
__attribute__((__overloadable__))
half16 _cl_minmag(half16 x0, half16 x1)
{
  typedef short iscalar_t;
  typedef short jscalar_t;
  typedef int kscalar_t;
...
// Implement minmag directly
__attribute__((__overloadable__))
float _cl_minmag(float x0, float x1)
{
...
// Implement minmag directly
__attribute__((__overloadable__))
float2 _cl_minmag(float2 x0, float2 x1)
{
  typedef int iscalar_t;
  typedef int jscalar_t;
  typedef int kscalar_t;
...
// Implement minmag directly
__attribute__((__overloadable__))
float3 _cl_minmag(float3 x0, float3 x1)
{
  typedef int iscalar_t;
  typedef int jscalar_t;
  typedef int kscalar_t;
...
// Implement minmag directly
__attribute__((__overloadable__))
float4 _cl_minmag(float4 x0, float4 x1)
{
  typedef int iscalar_t;
  typedef int jscalar_t;
  typedef int kscalar_t;
...
// Implement minmag directly
__attribute__((__overloadable__))
float8 _cl_minmag(float8 x0, float8 x1)
{
  typedef int iscalar_t;
  typedef int jscalar_t;
  typedef int kscalar_t;
...
// Implement minmag directly
__attribute__((__overloadable__))
float16 _cl_minmag(float16 x0, float16 x1)
{
  typedef int iscalar_t;
  typedef int jscalar_t;
  typedef int kscalar_t;
...
// Implement minmag directly
__attribute__((__overloadable__))
double _cl_minmag(double x0, double x1)
{
...
// Implement minmag directly
__attribute__((__overloadable__))
double2 _cl_minmag(double2 x0, double2 x1)
{
  typedef long iscalar_t;
...
// Implement minmag directly
__attribute__((__overloadable__))
double3 _cl_minmag(double3 x0, double3 x1)
{
  typedef long iscalar_t;
  typedef long jscalar_t;
  typedef int kscalar_t;
...
// Implement minmag directly
__attribute__((__overloadable__))
double4 _cl_minmag(double4 x0, double4 x1)
{
  typedef long iscalar_t;
  typedef long jscalar_t;
  typedef int kscalar_t;
...
// Implement minmag directly
__attribute__((__overloadable__))
double8 _cl_minmag(double8 x0, double8 x1)
{
  typedef long iscalar_t;
  typedef long jscalar_t;
  typedef int kscalar_t;
...
// Implement minmag directly
__attribute__((__overloadable__))
double16 _cl_minmag(double16 x0, double16 x1)
{
  typedef long iscalar_t;
  typedef long jscalar_t;
  typedef int kscalar_t;
