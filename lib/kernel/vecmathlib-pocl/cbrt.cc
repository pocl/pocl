...
// Implement cbrt by calling vecmathlib
half _cl_cbrt(half x0)
{
  vecmathlib::realvec<half,1> y0 = bitcast<half,vecmathlib::realvec<half,1> >(x0);
  vecmathlib::realvec<half,1> r = vecmathlib::cbrt(y0);
  return bitcast<vecmathlib::realvec<half,1>,half>((r));
}
#elif ! defined POCL_VECMATHLIB_BUILTIN
// Implement cbrt by calling libm
half _cl_cbrt(half x0)
{
  vecmathlib::realpseudovec<half,1> y0 = x0;
  vecmathlib::realpseudovec<half,1> r = cbrt(y0);
  return (r)[0];
}
#else
// Implement cbrt by calling builtin
half _cl_cbrt(half x0)
{
  vecmathlib::realbuiltinvec<half,1> y0 = x0;
  vecmathlib::realbuiltinvec<half,1> r = cbrt(y0);
  return (r)[0];
}
#endif
...
// Implement cbrt by using a larger vector size
half4 _cl_cbrt(half4);
half2 _cl_cbrt(half2 x0)
{
...
#else
// Implement cbrt by splitting into a smaller vector size
half _cl_cbrt(half);
half2 _cl_cbrt(half2 x0)
{
...
float _cl_cbrt(float x0)
{
  ...
  vecmathlib::realpseudovec<float,1> r = cbrt(y0);
  return (r)[0];
}
#else
// Implement cbrt by calling builtin
float _cl_cbrt(float x0)
{
  ...
  vecmathlib::realbuiltinvec<float,1> r = cbrt(y0);
  return (r)[0];
}
#endif
...
float2 _cl_cbrt(float2 x0)
{
  ...
  float4 r = _cl_cbrt(y0);
  return bitcast<float4,float2>(r);
}
#else
// Implement cbrt by splitting into a smaller vector size
float _cl_cbrt(float);
float2 _cl_cbrt(float2 x0)
{
...
// Implement cbrt by using a larger vector size
float8 _cl_cbrt(float8);
float4 _cl_cbrt(float4 x0)
{
  float8 y0 = bitcast<float4,float8>(x0);
  float8 r = _cl_cbrt(y0);
...
// Implement cbrt by using a larger vector size
float16 _cl_cbrt(float16);
float8 _cl_cbrt(float8 x0)
{
  float16 y0 = bitcast<float8,float16>(x0);
  float16 r = _cl_cbrt(y0);
...
double _cl_cbrt(double x0)
{
  ...
  vecmathlib::realpseudovec<double,1> r = cbrt(y0);
  return (r)[0];
}
#else
// Implement cbrt by calling builtin
double _cl_cbrt(double x0)
{
  ...
  vecmathlib::realbuiltinvec<double,1> r = cbrt(y0);
  return (r)[0];
}
#endif
...
double2 _cl_cbrt(double2 x0)
{
  ...
  double4 r = _cl_cbrt(y0);
  return bitcast<double4,double2>(r);
}
#else
// Implement cbrt by splitting into a smaller vector size
double _cl_cbrt(double);
double2 _cl_cbrt(double2 x0)
{
...
// Implement cbrt by using a larger vector size
double8 _cl_cbrt(double8);
double4 _cl_cbrt(double4 x0)
{
  double8 y0 = bitcast<double4,double8>(x0);
  double8 r = _cl_cbrt(y0);
...
// Implement cbrt by using a larger vector size
double16 _cl_cbrt(double16);
double8 _cl_cbrt(double8 x0)
{
  double16 y0 = bitcast<double8,double16>(x0);
  double16 r = _cl_cbrt(y0);
