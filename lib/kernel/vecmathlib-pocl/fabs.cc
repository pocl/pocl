...
half _cl_fabs(half x0)
{
  ...
  vecmathlib::realpseudovec<half,1> r = fabs(y0);
  return (r)[0];
}
#else
// Implement fabs by calling builtin
half _cl_fabs(half x0)
{
  vecmathlib::realbuiltinvec<half,1> y0 = x0;
  vecmathlib::realbuiltinvec<half,1> r = fabs(y0);
  return (r)[0];
}
#endif
...
float _cl_fabs(float x0)
{
  ...
  vecmathlib::realbuiltinvec<float,1> r = fabs(y0);
  return (r)[0];
}
#endif
...
double _cl_fabs(double x0)
{
  ...
  vecmathlib::realbuiltinvec<double,1> r = fabs(y0);
  return (r)[0];
}
#endif
