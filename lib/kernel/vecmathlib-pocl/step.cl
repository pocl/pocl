...
#define ldexp_vector_ _cl_ldexp_half_short
  return x1<x0 ? (vector_t)(scalar_t)0 : (vector_t)(scalar_t)1;
...
// Implement step directly
__attribute__((__overloadable__))
half2 _cl_step(half2 x0, half2 x1)
{
  typedef short iscalar_t;
...
// Implement step directly
__attribute__((__overloadable__))
half3 _cl_step(half3 x0, half3 x1)
{
  typedef short iscalar_t;
  typedef short jscalar_t;
  typedef int kscalar_t;
...
// Implement step directly
__attribute__((__overloadable__))
half4 _cl_step(half4 x0, half4 x1)
{
  typedef short iscalar_t;
  typedef short jscalar_t;
  typedef int kscalar_t;
...
// Implement step directly
__attribute__((__overloadable__))
half8 _cl_step(half8 x0, half8 x1)
{
  typedef short iscalar_t;
  typedef short jscalar_t;
  typedef int kscalar_t;
...
// Implement step directly
__attribute__((__overloadable__))
half16 _cl_step(half16 x0, half16 x1)
{
  typedef short iscalar_t;
  typedef short jscalar_t;
  typedef int kscalar_t;
...
// Implement step directly
__attribute__((__overloadable__))
half2 _cl_step(half x0, half2 x1)
{
  typedef short iscalar_t;
  typedef short jscalar_t;
  typedef int kscalar_t;
...
// Implement step directly
__attribute__((__overloadable__))
half3 _cl_step(half x0, half3 x1)
{
  typedef short iscalar_t;
  typedef short jscalar_t;
  typedef int kscalar_t;
...
// Implement step directly
__attribute__((__overloadable__))
half4 _cl_step(half x0, half4 x1)
{
  typedef short iscalar_t;
  typedef short jscalar_t;
  typedef int kscalar_t;
...
// Implement step directly
__attribute__((__overloadable__))
half8 _cl_step(half x0, half8 x1)
{
  typedef short iscalar_t;
  typedef short jscalar_t;
  typedef int kscalar_t;
...
// Implement step directly
__attribute__((__overloadable__))
half16 _cl_step(half x0, half16 x1)
{
  typedef short iscalar_t;
  typedef short jscalar_t;
  typedef int kscalar_t;
