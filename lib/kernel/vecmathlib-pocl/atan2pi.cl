...
// atan2pi: VF=half
// Implement atan2pi directly
__attribute__((__overloadable__))
half _cl_atan2pi(half x0, half x1)
{
...
#define ldexp_vector_ _cl_ldexp_half_short
  return atan2(x0,x1)/TYPED_CONST(scalar_t, M_PI_H, M_PI_F, M_PI);
...
// Implement atan2pi directly
__attribute__((__overloadable__))
half2 _cl_atan2pi(half2 x0, half2 x1)
{
  typedef short iscalar_t;
...
// Implement atan2pi directly
__attribute__((__overloadable__))
half3 _cl_atan2pi(half3 x0, half3 x1)
{
  typedef short iscalar_t;
  typedef short jscalar_t;
  typedef int kscalar_t;
...
// Implement atan2pi directly
__attribute__((__overloadable__))
half4 _cl_atan2pi(half4 x0, half4 x1)
{
  typedef short iscalar_t;
  typedef short jscalar_t;
  typedef int kscalar_t;
...
// Implement atan2pi directly
__attribute__((__overloadable__))
half8 _cl_atan2pi(half8 x0, half8 x1)
{
  typedef short iscalar_t;
  typedef short jscalar_t;
  typedef int kscalar_t;
...
// Implement atan2pi directly
__attribute__((__overloadable__))
half16 _cl_atan2pi(half16 x0, half16 x1)
{
  typedef short iscalar_t;
  typedef short jscalar_t;
  typedef int kscalar_t;
