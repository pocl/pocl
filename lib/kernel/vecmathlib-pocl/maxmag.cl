...
half _cl_maxmag(half x0, half x1)
{
...
// Implement maxmag directly
__attribute__((__overloadable__))
half2 _cl_maxmag(half2 x0, half2 x1)
{
  typedef short iscalar_t;
...
// Implement maxmag directly
__attribute__((__overloadable__))
half3 _cl_maxmag(half3 x0, half3 x1)
{
  typedef short iscalar_t;
  typedef short jscalar_t;
  typedef int kscalar_t;
...
// Implement maxmag directly
__attribute__((__overloadable__))
half4 _cl_maxmag(half4 x0, half4 x1)
{
  typedef short iscalar_t;
  typedef short jscalar_t;
  typedef int kscalar_t;
...
// Implement maxmag directly
__attribute__((__overloadable__))
half8 _cl_maxmag(half8 x0, half8 x1)
{
  typedef short iscalar_t;
  typedef short jscalar_t;
  typedef int kscalar_t;
...
// Implement maxmag directly
__attribute__((__overloadable__))
half16 _cl_maxmag(half16 x0, half16 x1)
{
  typedef short iscalar_t;
  typedef short jscalar_t;
  typedef int kscalar_t;
