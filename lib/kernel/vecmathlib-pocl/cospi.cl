...
// cospi: VF=half
// Implement cospi directly
__attribute__((__overloadable__))
half _cl_cospi(half x0)
{
...
#define ldexp_vector_ _cl_ldexp_half_short
  return cos(TYPED_CONST(scalar_t, M_PI_H, M_PI_F, M_PI)*x0);
...
// Implement cospi directly
__attribute__((__overloadable__))
double16 _cl_cospi(double16 x0)
{
  typedef long iscalar_t;
  typedef long jscalar_t;
  typedef int kscalar_t;
