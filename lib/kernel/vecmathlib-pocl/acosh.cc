...
// Implement acosh by calling vecmathlib
half _cl_acosh(half x0)
{
  vecmathlib::realvec<half,1> y0 = bitcast<half,vecmathlib::realvec<half,1> >(x0);
  vecmathlib::realvec<half,1> r = vecmathlib::acosh(y0);
  return bitcast<vecmathlib::realvec<half,1>,half>((r));
}
#elif ! defined POCL_VECMATHLIB_BUILTIN
// Implement acosh by calling libm
half _cl_acosh(half x0)
{
  vecmathlib::realpseudovec<half,1> y0 = x0;
  vecmathlib::realpseudovec<half,1> r = acosh(y0);
  return (r)[0];
}
#else
// Implement acosh by calling builtin
half _cl_acosh(half x0)
{
  vecmathlib::realbuiltinvec<half,1> y0 = x0;
  vecmathlib::realbuiltinvec<half,1> r = acosh(y0);
  return (r)[0];
}
#endif
...
// Implement acosh by calling vecmathlib
half2 _cl_acosh(half2 x0)
{
  vecmathlib::realvec<half,2> y0 = bitcast<half2,vecmathlib::realvec<half,2> >(x0);
  vecmathlib::realvec<half,2> r = vecmathlib::acosh(y0);
...
// Implement acosh by using a larger vector size
half4 _cl_acosh(half4);
half2 _cl_acosh(half2 x0)
{
  half4 y0 = bitcast<half2,half4>(x0);
  half4 r = _cl_acosh(y0);
  return bitcast<half4,half2>(r);
}
#else
// Implement acosh by splitting into a smaller vector size
half _cl_acosh(half);
half2 _cl_acosh(half2 x0)
{
  pair_half y0 = bitcast<half2,pair_half>(x0);
  pair_half r;
  r.lo = _cl_acosh(y0.lo);
  r.hi = _cl_acosh(y0.hi);
...
// Implement acosh by calling vecmathlib
half3 _cl_acosh(half3 x0)
{
  vecmathlib::realvec<half,3> y0 = bitcast<half3,vecmathlib::realvec<half,3> >(x0);
  vecmathlib::realvec<half,3> r = vecmathlib::acosh(y0);
...
// Implement acosh by calling vecmathlib
half4 _cl_acosh(half4 x0)
{
  vecmathlib::realvec<half,4> y0 = bitcast<half4,vecmathlib::realvec<half,4> >(x0);
  vecmathlib::realvec<half,4> r = vecmathlib::acosh(y0);
...
// Implement acosh by using a larger vector size
half8 _cl_acosh(half8);
half4 _cl_acosh(half4 x0)
{
  half8 y0 = bitcast<half4,half8>(x0);
  half8 r = _cl_acosh(y0);
...
// Implement acosh by calling vecmathlib
half16 _cl_acosh(half16 x0)
{
  vecmathlib::realvec<half,16> y0 = bitcast<half16,vecmathlib::realvec<half,16> >(x0);
  vecmathlib::realvec<half,16> r = vecmathlib::acosh(y0);
...
float _cl_acosh(float x0)
{
  ...
  vecmathlib::realpseudovec<float,1> r = acosh(y0);
  return (r)[0];
}
#else
// Implement acosh by calling builtin
float _cl_acosh(float x0)
{
  ...
  vecmathlib::realbuiltinvec<float,1> r = acosh(y0);
  return (r)[0];
}
#endif
...
// Implement acosh by calling vecmathlib
float2 _cl_acosh(float2 x0)
{
  vecmathlib::realvec<float,2> y0 = bitcast<float2,vecmathlib::realvec<float,2> >(x0);
  vecmathlib::realvec<float,2> r = vecmathlib::acosh(y0);
...
float2 _cl_acosh(float2 x0)
{
  ...
  float4 r = _cl_acosh(y0);
  return bitcast<float4,float2>(r);
}
#else
// Implement acosh by splitting into a smaller vector size
float _cl_acosh(float);
float2 _cl_acosh(float2 x0)
{
...
// Implement acosh by calling vecmathlib
float3 _cl_acosh(float3 x0)
{
  vecmathlib::realvec<float,3> y0 = bitcast<float3,vecmathlib::realvec<float,3> >(x0);
  vecmathlib::realvec<float,3> r = vecmathlib::acosh(y0);
...
// Implement acosh by calling vecmathlib
float4 _cl_acosh(float4 x0)
{
  vecmathlib::realvec<float,4> y0 = bitcast<float4,vecmathlib::realvec<float,4> >(x0);
  vecmathlib::realvec<float,4> r = vecmathlib::acosh(y0);
...
// Implement acosh by using a larger vector size
float8 _cl_acosh(float8);
float4 _cl_acosh(float4 x0)
{
  float8 y0 = bitcast<float4,float8>(x0);
  float8 r = _cl_acosh(y0);
...
// Implement acosh by calling vecmathlib
float8 _cl_acosh(float8 x0)
{
  vecmathlib::realvec<float,8> y0 = bitcast<float8,vecmathlib::realvec<float,8> >(x0);
  vecmathlib::realvec<float,8> r = vecmathlib::acosh(y0);
...
// Implement acosh by using a larger vector size
float16 _cl_acosh(float16);
float8 _cl_acosh(float8 x0)
{
  float16 y0 = bitcast<float8,float16>(x0);
  float16 r = _cl_acosh(y0);
...
// Implement acosh by calling vecmathlib
float16 _cl_acosh(float16 x0)
{
  vecmathlib::realvec<float,16> y0 = bitcast<float16,vecmathlib::realvec<float,16> >(x0);
  vecmathlib::realvec<float,16> r = vecmathlib::acosh(y0);
...
double _cl_acosh(double x0)
{
  ...
  vecmathlib::realpseudovec<double,1> r = acosh(y0);
  return (r)[0];
}
#else
// Implement acosh by calling builtin
double _cl_acosh(double x0)
{
  ...
  vecmathlib::realbuiltinvec<double,1> r = acosh(y0);
  return (r)[0];
}
#endif
...
// Implement acosh by calling vecmathlib
double2 _cl_acosh(double2 x0)
{
  vecmathlib::realvec<double,2> y0 = bitcast<double2,vecmathlib::realvec<double,2> >(x0);
  vecmathlib::realvec<double,2> r = vecmathlib::acosh(y0);
...
double2 _cl_acosh(double2 x0)
{
  ...
  double4 r = _cl_acosh(y0);
  return bitcast<double4,double2>(r);
}
#else
// Implement acosh by splitting into a smaller vector size
double _cl_acosh(double);
double2 _cl_acosh(double2 x0)
{
...
// Implement acosh by calling vecmathlib
double3 _cl_acosh(double3 x0)
{
  vecmathlib::realvec<double,3> y0 = bitcast<double3,vecmathlib::realvec<double,3> >(x0);
  vecmathlib::realvec<double,3> r = vecmathlib::acosh(y0);
...
// Implement acosh by calling vecmathlib
double4 _cl_acosh(double4 x0)
{
  vecmathlib::realvec<double,4> y0 = bitcast<double4,vecmathlib::realvec<double,4> >(x0);
  vecmathlib::realvec<double,4> r = vecmathlib::acosh(y0);
...
// Implement acosh by using a larger vector size
double8 _cl_acosh(double8);
double4 _cl_acosh(double4 x0)
{
  double8 y0 = bitcast<double4,double8>(x0);
  double8 r = _cl_acosh(y0);
...
// Implement acosh by calling vecmathlib
double8 _cl_acosh(double8 x0)
{
  vecmathlib::realvec<double,8> y0 = bitcast<double8,vecmathlib::realvec<double,8> >(x0);
  vecmathlib::realvec<double,8> r = vecmathlib::acosh(y0);
...
// Implement acosh by using a larger vector size
double16 _cl_acosh(double16);
double8 _cl_acosh(double8 x0)
{
  double16 y0 = bitcast<double8,double16>(x0);
  double16 r = _cl_acosh(y0);
...
// Implement acosh by calling vecmathlib
double16 _cl_acosh(double16 x0)
{
  vecmathlib::realvec<double,16> y0 = bitcast<double16,vecmathlib::realvec<double,16> >(x0);
  vecmathlib::realvec<double,16> r = vecmathlib::acosh(y0);
