...
half _cl_round(half x0)
{
  ...
  vecmathlib::realpseudovec<half,1> r = round(y0);
  return (r)[0];
}
#else
// Implement round by calling builtin
half _cl_round(half x0)
{
  vecmathlib::realbuiltinvec<half,1> y0 = x0;
  vecmathlib::realbuiltinvec<half,1> r = round(y0);
  return (r)[0];
}
#endif
...
// Implement round by calling vecmathlib
half2 _cl_round(half2 x0)
{
  vecmathlib::realvec<half,2> y0 = bitcast<half2,vecmathlib::realvec<half,2> >(x0);
  vecmathlib::realvec<half,2> r = vecmathlib::round(y0);
...
half4 _cl_round(half4);
half2 _cl_round(half2 x0)
{
  half4 y0 = bitcast<half2,half4>(x0);
  half4 r = _cl_round(y0);
...
// Implement round by calling vecmathlib
half3 _cl_round(half3 x0)
{
  vecmathlib::realvec<half,3> y0 = bitcast<half3,vecmathlib::realvec<half,3> >(x0);
  vecmathlib::realvec<half,3> r = vecmathlib::round(y0);
...
// Implement round by calling vecmathlib
half4 _cl_round(half4 x0)
{
  vecmathlib::realvec<half,4> y0 = bitcast<half4,vecmathlib::realvec<half,4> >(x0);
  vecmathlib::realvec<half,4> r = vecmathlib::round(y0);
...
// Implement round by using a larger vector size
half8 _cl_round(half8);
half4 _cl_round(half4 x0)
{
  half8 y0 = bitcast<half4,half8>(x0);
  half8 r = _cl_round(y0);
...
// Implement round by calling vecmathlib
half16 _cl_round(half16 x0)
{
  vecmathlib::realvec<half,16> y0 = bitcast<half16,vecmathlib::realvec<half,16> >(x0);
  vecmathlib::realvec<half,16> r = vecmathlib::round(y0);
...
float _cl_round(float x0)
{
  ...
  vecmathlib::realbuiltinvec<float,1> r = round(y0);
  return (r)[0];
}
#endif
...
double _cl_round(double x0)
{
  ...
  vecmathlib::realbuiltinvec<double,1> r = round(y0);
  return (r)[0];
}
#endif
