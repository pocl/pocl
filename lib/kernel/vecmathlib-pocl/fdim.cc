...
half _cl_fdim(half x0, half x1)
{
  ...
  vecmathlib::realvec<half,1> r = vecmathlib::fdim(y0, y1);
...
half _cl_fdim(half x0, half x1)
{
  ...
  vecmathlib::realpseudovec<half,1> r = fdim(y0, y1);
  return (r)[0];
}
#else
...
half _cl_fdim(half x0, half x1)
{
  ...
  vecmathlib::realbuiltinvec<half,1> r = fdim(y0, y1);
  return (r)[0];
}
#endif
...
// Implement fdim by calling vecmathlib
half2 _cl_fdim(half2 x0, half2 x1)
{
  ...
  vecmathlib::realvec<half,2> r = vecmathlib::fdim(y0, y1);
...
// Implement fdim by calling vecmathlib
half3 _cl_fdim(half3 x0, half3 x1)
{
  ...
  vecmathlib::realvec<half,3> r = vecmathlib::fdim(y0, y1);
...
// Implement fdim by calling vecmathlib
half4 _cl_fdim(half4 x0, half4 x1)
{
  ...
  vecmathlib::realvec<half,4> r = vecmathlib::fdim(y0, y1);
...
// Implement fdim by calling vecmathlib
half8 _cl_fdim(half8 x0, half8 x1)
{
...
// Implement fdim by calling vecmathlib
half16 _cl_fdim(half16 x0, half16 x1)
{
  ...
  vecmathlib::realvec<half,16> r = vecmathlib::fdim(y0, y1);
