...
half _cl_floor(half x0)
{
  ...
  vecmathlib::realpseudovec<half,1> r = floor(y0);
  return (r)[0];
}
#else
...
half _cl_floor(half x0)
{
  ...
  vecmathlib::realbuiltinvec<half,1> r = floor(y0);
  return (r)[0];
}
#endif
...
// Implement floor by calling vecmathlib
half2 _cl_floor(half2 x0)
{
  vecmathlib::realvec<half,2> y0 = bitcast<half2,vecmathlib::realvec<half,2> >(x0);
  vecmathlib::realvec<half,2> r = vecmathlib::floor(y0);
...
half4 _cl_floor(half4);
half2 _cl_floor(half2 x0)
{
  half4 y0 = bitcast<half2,half4>(x0);
  half4 r = _cl_floor(y0);
...
// Implement floor by calling vecmathlib
half3 _cl_floor(half3 x0)
{
  vecmathlib::realvec<half,3> y0 = bitcast<half3,vecmathlib::realvec<half,3> >(x0);
  vecmathlib::realvec<half,3> r = vecmathlib::floor(y0);
...
// Implement floor by calling vecmathlib
half4 _cl_floor(half4 x0)
{
  vecmathlib::realvec<half,4> y0 = bitcast<half4,vecmathlib::realvec<half,4> >(x0);
  vecmathlib::realvec<half,4> r = vecmathlib::floor(y0);
...
// Implement floor by using a larger vector size
half8 _cl_floor(half8);
half4 _cl_floor(half4 x0)
{
  half8 y0 = bitcast<half4,half8>(x0);
  half8 r = _cl_floor(y0);
...
// Implement floor by calling vecmathlib
half16 _cl_floor(half16 x0)
{
  vecmathlib::realvec<half,16> y0 = bitcast<half16,vecmathlib::realvec<half,16> >(x0);
  vecmathlib::realvec<half,16> r = vecmathlib::floor(y0);
