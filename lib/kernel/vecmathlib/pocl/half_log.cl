...
// Implement half_log directly
__attribute__((__overloadable__))
float16 _cl_half_log(float16 x0)
{
  typedef int kscalar_t;
  typedef float scalar_t;
