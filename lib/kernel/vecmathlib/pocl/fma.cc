...
// Implement fma by using a larger vector size
float32 _cl_fma(float32, float32, float32);
float16 _cl_fma(float16 x0, float16 x1, float16 x2)
{
  float32 y0 = bitcast<float16,float32>(x0);
  float32 y1 = bitcast<float16,float32>(x1);
  float32 y2 = bitcast<float16,float32>(x2);
  float32 r = _cl_fma(y0, y1, y2);
...
// Implement fma by using a larger vector size
double32 _cl_fma(double32, double32, double32);
double16 _cl_fma(double16 x0, double16 x1, double16 x2)
{
  double32 y0 = bitcast<double16,double32>(x0);
  double32 y1 = bitcast<double16,double32>(x1);
  double32 y2 = bitcast<double16,double32>(x2);
  double32 r = _cl_fma(y0, y1, y2);
