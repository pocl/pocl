...
float _cl_exp2(float x0)
{
  ...
  vecmathlib::realpseudovec<float,1> r = exp2(y0);
  return (r)[0];
}
#endif
...
double _cl_exp2(double x0)
{
  ...
  vecmathlib::realpseudovec<double,1> r = exp2(y0);
  return (r)[0];
}
#endif
...
double2 _cl_exp2(double2 x0)
{
  ...
  double4 r = _cl_exp2(y0);
  return bitcast<double4,double2>(r);
}
#else
// Implement exp2 by splitting into a smaller vector size
double _cl_exp2(double);
double2 _cl_exp2(double2 x0)
{
