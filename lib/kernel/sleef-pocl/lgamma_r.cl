...
_CL_OVERLOADABLE
float
_cl_lgamma_r (float x, generic int *iptr)
{
  Sleef_float2 temp;
  temp = Sleef_lgamma_rf_u10(x);
  *iptr = convert_int(temp.y);
...
_CL_OVERLOADABLE
float3
_cl_lgamma_r (float3 x, generic int3 *iptr)
{
  int4 temp;
  float4 x_3to4;
  x_3to4.xyz = x;
...
_CL_OVERLOADABLE
float2
_cl_lgamma_r (float2 x, generic int2 *iptr)
{
  int plo, phi;
  float lo = _cl_lgamma_r (x.lo, &plo);
  float hi = _cl_lgamma_r (x.hi, &phi);
...
_CL_OVERLOADABLE
float4
_cl_lgamma_r (float4 x, generic int4 *iptr)
{
#if defined(SLEEF_VEC_128_AVAILABLE)
  Sleef_float4_2 temp;
  temp = Sleef_lgamma_rf4_u10(x);
...
_CL_OVERLOADABLE
float8
_cl_lgamma_r (float8 x, generic int8 *iptr)
{
#if defined(SLEEF_VEC_256_AVAILABLE)
  Sleef_float8_2 temp;
  temp = Sleef_lgamma_rf8_u10(x);
...
_CL_OVERLOADABLE
float16
_cl_lgamma_r (float16 x, generic int16 *iptr)
{
#if defined(SLEEF_VEC_512_AVAILABLE)
  Sleef_float16_2 temp;
  temp = Sleef_lgamma_rf16_u10(x);
...
_CL_OVERLOADABLE
double
_cl_lgamma_r (double x, generic int *iptr)
{
  Sleef_double2 temp;
  temp = Sleef_lgamma_r_u10(x);
  *iptr = convert_int(temp.y);
...
_CL_OVERLOADABLE
double3
_cl_lgamma_r (double3 x, generic int3 *iptr)
{
  int4 temp;
  double4 x_3to4;
  x_3to4.xyz = x;
...
_CL_OVERLOADABLE
double16
_cl_lgamma_r (double16 x, generic int16 *iptr)
{
  int8 plo, phi;
  double8 lo = _cl_lgamma_r (x.lo, &plo);
  double8 hi = _cl_lgamma_r (x.hi, &phi);
...
_CL_OVERLOADABLE
double2
_cl_lgamma_r (double2 x, generic int2 *iptr)
{
#if defined(SLEEF_VEC_128_AVAILABLE) && defined(SLEEF_DOUBLE_VEC_AVAILABLE)
  Sleef_double2_2 temp;
  temp = Sleef_lgamma_rd2_u10(x);
...
_CL_OVERLOADABLE
double4
_cl_lgamma_r (double4 x, generic int4 *iptr)
{
#if defined(SLEEF_VEC_256_AVAILABLE) && defined(SLEEF_DOUBLE_VEC_AVAILABLE)
  Sleef_double4_2 temp;
  temp = Sleef_lgamma_rd4_u10(x);
...
_CL_OVERLOADABLE
double8
_cl_lgamma_r (double8 x, generic int8 *iptr)
{
#if defined(SLEEF_VEC_512_AVAILABLE) && defined(SLEEF_DOUBLE_VEC_AVAILABLE)
  Sleef_double8_2 temp;
  temp = Sleef_lgamma_rd8_u10(x);
